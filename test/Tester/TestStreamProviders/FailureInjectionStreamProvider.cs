...
namespace Tester.TestStreamProviders
{
    ...
    /// </summary>
    /*public class FailureInjectionStreamProviderMode
    {
        public static string FAILURE_INJECTION_STREAM_PROVIDER_MODE = "FailureInjectionStreamProviderMode";
        public static string INITIALIZATION_THROWS_EXCEPTION = "InitializationThrowsException";
        public static string START_THROWS_EXCEPTION = "StartThrowsException";
    }*/
